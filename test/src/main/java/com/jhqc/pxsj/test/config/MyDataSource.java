...
import com.jhqc.pxsj.test.domain.OrderAddress;
...
public class MyDataSource {
	...
	public CriteriaBuilder criteriaBuilder() {
	    com.jhqc.pxsj.core.Configuration conf = new com.jhqc.pxsj.core.Configuration();
        
        conf.addDomainModel(OrderBase.class);
        conf.addDomainModel(OrderMonitor.class);
        conf.addDomainModel(OrderPay.class);
        conf.addDomainModel(OrderPayType.class);
        conf.addDomainModel(OrderAddress.class);
        conf.addDomainModel(OrderDelivery.class);
