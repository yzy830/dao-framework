...
public class Goods_ {
    public static final Class<?> domain = com.jhqc.pxsj.core.Goods.class;
    ...
    public static final Meta<java.lang.Long> shopId = Meta.<java.lang.Long>newInstance(descriptors.get("shopId"));
}